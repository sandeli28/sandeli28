...
### 🩺 PCOS Detection & Tracking System with Explainable AI

An end-to-end ML application for PCOS risk prediction with explainable predictions.

**Highlights:**
- Built an ensemble-based ML prediction pipeline
- Implemented **stacking with multiple ML models**
- Used **SHAP** for model interpretability
- Applied preprocessing pipelines for numerical and categorical features
- Integrated the trained ML model with a web application
- Focused on making model predictions more understandable to users

**Tech:** `Python` `Scikit-learn` `XGBoost` `LightGBM` `CatBoost` `SHAP` `React` `Flask`

---

### 🤖 Agentic AI & LLM Applications

Exploring intelligent systems where LLM-based agents can reason, use tools, retrieve information, and execute multi-step workflows.
...
**Tech:** `Python` `LangChain` `LangGraph` `LLMs` `RAG` `Vector DBs`
